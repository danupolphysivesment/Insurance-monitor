...
searches are now retried with backoff (6s → 15s → 33s, jittered), and anything
that still fails is listed in the scan summary rather than swallowed. If you see
...
Requires the **firecrawl** CLI on your PATH (already installed and authenticated
on this machine).
